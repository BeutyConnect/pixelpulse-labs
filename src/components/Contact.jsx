    ...
    <section className="py-24 px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-12">
          ...
          {/* Why Choose Us */}
          <motion.div
            className="glass-card p-8 rounded-2xl bg-gradient-to-br from-primary/10 to-accent/10 mt-10"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <motion.ul
              className="grid md:grid-cols-2 gap-3 text-sm text-muted-foreground"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
