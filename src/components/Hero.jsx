    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            background: `radial-gradient(600px circle at ${50 + mousePosition.x * 20}% ${50 + mousePosition.y * 20}%, 
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <span className="text-sm font-medium text-white">Digital Innovation Experts</span>
          </motion.div>
