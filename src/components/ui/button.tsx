  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-primary-foreground hover:shadow-glow-primary transform hover:scale-105 font-semibold",
        accent: "gradient-accent text-accent-foreground hover:shadow-glow-accent transform hover:scale-105 font-semibold",
        glass: "glass-card text-foreground hover:bg-card/90 backdrop-blur-xl border-white/20",
      },
      size: {
