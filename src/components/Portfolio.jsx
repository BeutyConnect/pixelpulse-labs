          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <motion.div
                ...
                whileHover={{
                  boxShadow:
                    "0 40px 80px rgba(99, 102, 241, 0.3), 0 0 50px rgba(139, 92, 246, 0.2)",
                  transition: { duration: 0.3 },
                }}
                style={{
                  transform:
                  ...
                  >
                    ...
                    >
                      <Button
                        variant="outline"
                        size="sm"
                        className="w-full border-indigo-500/30 hover:border-indigo-500 hover:bg-indigo-500/10 transition-all duration-300"
                      >
                    ...
                    >
                      <Button
                        variant="ghost"
                        size="sm"
                        className="w-full hover:bg-purple-500/10 hover:text-purple-400 transition-all duration-300"
                      >
